/**
 * @file dd_a_qd.c
 * @brief It enable to offload double-double and quad-double vector or matrix addition to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _dd_a_qd(out1,out2,out3,out4,in1,in2,in5,in6,in7,in8,m,n,omp_threadNum,avx);
