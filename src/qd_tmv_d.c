/**
 * @file qd_tmv_d.c
 * @brief It enable to offload quad-double and double transposed matrix-vector multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _qd_tmv_d(out1,out2,out3,out4,in8,in1,in5,in6,in7,m,l,n,omp_threadNum,avx,fma);
}