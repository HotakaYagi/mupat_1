/**
 * @file dd_mm_dd_ieee.c
 * @brief It enable to offload double-double and double-double matrix multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _dd_mm_dd_ieee(out1,out2,in1,in2,in3,in4,m,n,l,omp_threadNum,avx,fma);
}
