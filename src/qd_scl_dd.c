/**
 * @file qd_scl_dd.c
 * @brief It enable to offload quad-double and double-double scaler to outer C from MATLAB.
 * @author Hotaka Yagi
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    if ((l==1)&&(k==1)){ //qdx-dda
        ...
        _dd_scl_qd(out1,out2,out3,out4,in7,in8,in1,in2,in5,in6,m,n,omp_threadNum,avx,fma);
    }else if ((m==1)&&(n==1)){ //ax
        /* create the output matrix */
        ...
        /* call the computational routine */
        _qd_scl_dd(out1,out2,out3,out4,in1,in2,in5,in6,in7,in8,l,k,omp_threadNum,avx,fma);
    }
}