/**
 * @file qd_mm_qd.c
 * @brief It enable to offload quad-double and quad-double multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[]){
    ...
    _qd_mm_qd(out1,out2,out3,out4,in1,in2,in3,in4,in5,in6,in7,in8,m,l,n,omp_threadNum,avx,fma);
}