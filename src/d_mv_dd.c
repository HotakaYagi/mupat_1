/**
 * @file d_mv_dd.c
 * @brief It enable to offload double and double-double matrix-vector multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _d_mv_dd(out1,out2,in1,in3,in4,m,n,l,omp_threadNum,avx,fma);
}