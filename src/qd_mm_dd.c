/**
 * @file qd_mm_dd.c
 * @brief It enable to offload quad-double and double-double matrix multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    l = (mwSize)mxGetN(prhs[4]); //RETU y.hh
    /* get dimensions of the input matrix */
    ...
    _qd_mm_dd(out1,out2,out3,out4,in7,in8,in1,in2,in5,in6,m,l,n,omp_threadNum,avx,fma);
}