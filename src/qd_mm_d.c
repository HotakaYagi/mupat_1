/**
 * @file qd_mm_d.c
 * @brief It enable to offload quad-double and double matrix multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _qd_mm_d(out1,out2,out3,out4,in8,in1,in5,in6,in7,m,l,n,omp_threadNum,avx,fma);
}