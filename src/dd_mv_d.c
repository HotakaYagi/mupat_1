/**
 * @file dd_mv_d.c
 * @brief It enable to offload double-double and double matrix-vector multiplication to outer C from MATLAB.
 * @author Hotaka Yagi
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){
    ...
    _dd_mv_d(out1,out2,in1,in2,in3,m,n,l,omp_threadNum,avx,fma);
}
