/**
 * @file d_scl_dd.c
 * @brief It enable to offload double and double-double scaler to outer C from MATLAB.
 * @author Hotaka Yagi
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    if ((l==1)&&(k==1)){ //dx-dda
        ...
        _dd_scl_d(out1,out2,in3,in4,in1,m,n,omp_threadNum,avx,fma);
    }else if ((m==1)&&(n==1)){ //da-ddx
        ...
        /* call the computational routine */
        _d_scl_dd(out1,out2,in1,in3,in4,l,k,omp_threadNum,avx,fma);
    }
}